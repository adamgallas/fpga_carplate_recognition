...
(* CORE_GENERATION_INFO="box,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=9.400000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=6,HLS_SYN_DSP=43,HLS_SYN_FF=11485,HLS_SYN_LUT=12276,HLS_VERSION=2019_2}" *)
...
wire   [31:0] ytop_s;
wire   [31:0] ydown_s;
wire    Block_Mat_exit22_pro_U0_ap_start;
wire    Block_Mat_exit22_pro_U0_start_full_n;
wire    Block_Mat_exit22_pro_U0_ap_done;
wire    Block_Mat_exit22_pro_U0_ap_continue;
wire    Block_Mat_exit22_pro_U0_ap_idle;
wire    Block_Mat_exit22_pro_U0_ap_ready;
wire    Block_Mat_exit22_pro_U0_start_out;
wire    Block_Mat_exit22_pro_U0_start_write;
wire   [31:0] Block_Mat_exit22_pro_U0_xleft_out_din;
wire    Block_Mat_exit22_pro_U0_xleft_out_write;
wire   [31:0] Block_Mat_exit22_pro_U0_xleft_out1_din;
wire    Block_Mat_exit22_pro_U0_xleft_out1_write;
wire   [31:0] Block_Mat_exit22_pro_U0_xright_out_din;
wire    Block_Mat_exit22_pro_U0_xright_out_write;
wire   [31:0] Block_Mat_exit22_pro_U0_xright_out2_din;
wire    Block_Mat_exit22_pro_U0_xright_out2_write;
wire   [31:0] Block_Mat_exit22_pro_U0_ytop_out_din;
wire    Block_Mat_exit22_pro_U0_ytop_out_write;
wire   [31:0] Block_Mat_exit22_pro_U0_ytop_out3_din;
wire    Block_Mat_exit22_pro_U0_ytop_out3_write;
wire   [31:0] Block_Mat_exit22_pro_U0_ydown_out_din;
wire    Block_Mat_exit22_pro_U0_ydown_out_write;
wire   [31:0] Block_Mat_exit22_pro_U0_ydown_out4_din;
wire    Block_Mat_exit22_pro_U0_ydown_out4_write;
wire   [10:0] Block_Mat_exit22_pro_U0_rgb_img_rows_V_out_din;
wire    Block_Mat_exit22_pro_U0_rgb_img_rows_V_out_write;
wire   [11:0] Block_Mat_exit22_pro_U0_rgb_img_cols_V_out_din;
wire    Block_Mat_exit22_pro_U0_rgb_img_cols_V_out_write;
wire   [31:0] Block_Mat_exit22_pro_U0_plate_rows_V_out_din;
wire    Block_Mat_exit22_pro_U0_plate_rows_V_out_write;
wire   [31:0] Block_Mat_exit22_pro_U0_plate_cols_V_out_din;
wire    Block_Mat_exit22_pro_U0_plate_cols_V_out_write;
wire   [6:0] Block_Mat_exit22_pro_U0_standard_plate_rows_V_out_din;
wire    Block_Mat_exit22_pro_U0_standard_plate_rows_V_out_write;
wire   [8:0] Block_Mat_exit22_pro_U0_standard_plate_cols_V_out_din;
wire    Block_Mat_exit22_pro_U0_standard_plate_cols_V_out_write;
...
wire   [6:0] Resize_U0_p_dst_rows_V_out_din;
wire    Resize_U0_p_dst_rows_V_out_write;
wire   [8:0] Resize_U0_p_dst_cols_V_out_din;
...
wire    Loop_BRAM_LOOP_proc1_U0_ap_start;
wire    Loop_BRAM_LOOP_proc1_U0_ap_done;
wire    Loop_BRAM_LOOP_proc1_U0_ap_continue;
wire    Loop_BRAM_LOOP_proc1_U0_ap_idle;
wire    Loop_BRAM_LOOP_proc1_U0_ap_ready;
wire   [31:0] Loop_BRAM_LOOP_proc1_U0_buffer_V_Addr_A;
wire    Loop_BRAM_LOOP_proc1_U0_buffer_V_EN_A;
wire   [3:0] Loop_BRAM_LOOP_proc1_U0_buffer_V_WEN_A;
wire   [31:0] Loop_BRAM_LOOP_proc1_U0_buffer_V_Din_A;
wire    Loop_BRAM_LOOP_proc1_U0_gray_plate_data_stream_0_V_read;
...
wire    xleft_c35_full_n;
wire   [31:0] xleft_c35_dout;
wire    xleft_c35_empty_n;
wire    xright_c_full_n;
wire   [31:0] xright_c_dout;
wire    xright_c_empty_n;
wire    xright_c36_full_n;
wire   [31:0] xright_c36_dout;
wire    xright_c36_empty_n;
wire    ytop_c_full_n;
wire   [31:0] ytop_c_dout;
wire    ytop_c_empty_n;
wire    ytop_c37_full_n;
wire   [31:0] ytop_c37_dout;
wire    ytop_c37_empty_n;
wire    ydown_c_full_n;
wire   [31:0] ydown_c_dout;
wire    ydown_c_empty_n;
wire    ydown_c38_full_n;
wire   [31:0] ydown_c38_dout;
wire    ydown_c38_empty_n;
...
wire    standard_plate_rows_1_full_n;
wire   [6:0] standard_plate_rows_1_dout;
wire    standard_plate_rows_1_empty_n;
wire    standard_plate_cols_1_full_n;
wire   [8:0] standard_plate_cols_1_dout;
wire    standard_plate_cols_1_empty_n;
...
wire    rgb_img_rows_V_c39_full_n;
wire   [10:0] rgb_img_rows_V_c39_dout;
wire    rgb_img_rows_V_c39_empty_n;
wire    rgb_img_cols_V_c40_full_n;
wire   [11:0] rgb_img_cols_V_c40_dout;
wire    rgb_img_cols_V_c40_empty_n;
...
wire    standard_plate_rows_s_full_n;
wire   [6:0] standard_plate_rows_s_dout;
wire    standard_plate_rows_s_empty_n;
wire    standard_plate_cols_s_full_n;
wire   [8:0] standard_plate_cols_s_dout;
wire    standard_plate_cols_s_empty_n;
wire    gray_plate_data_stre_full_n;
wire   [7:0] gray_plate_data_stre_dout;
wire    gray_plate_data_stre_empty_n;
...
wire    ap_sync_done;
wire    ap_sync_ready;
reg    ap_sync_reg_Block_Mat_exit22_pro_U0_ap_ready;
wire    ap_sync_Block_Mat_exit22_pro_U0_ap_ready;
reg   [1:0] Block_Mat_exit22_pro_U0_ap_ready_count;
...
wire   [0:0] start_for_Loop_BRAM_LOOP_proc1_U0_din;
wire    start_for_Loop_BRAM_LOOP_proc1_U0_full_n;
wire   [0:0] start_for_Loop_BRAM_LOOP_proc1_U0_dout;
wire    start_for_Loop_BRAM_LOOP_proc1_U0_empty_n;
wire    Loop_BRAM_LOOP_proc1_U0_start_full_n;
wire    Loop_BRAM_LOOP_proc1_U0_start_write;
...
initial begin
#0 ap_sync_reg_Block_Mat_exit22_pro_U0_ap_ready = 1'b0;
#0 Block_Mat_exit22_pro_U0_ap_ready_count = 2'd0;
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_sync_reg_Block_Mat_exit22_pro_U0_ap_ready <= 1'b0;
    end else begin
        if (((ap_sync_ready & ap_start) == 1'b1)) begin
            ap_sync_reg_Block_Mat_exit22_pro_U0_ap_ready <= 1'b0;
        end else begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == Block_Mat_exit22_pro_U0_ap_ready) & (ap_sync_ready == 1'b1))) begin
        Block_Mat_exit22_pro_U0_ap_ready_count <= (Block_Mat_exit22_pro_U0_ap_ready_count - 2'd1);
    end else if (((ap_sync_ready == 1'b0) & (1'b1 == Block_Mat_exit22_pro_U0_ap_ready))) begin
        Block_Mat_exit22_pro_U0_ap_ready_count <= (Block_Mat_exit22_pro_U0_ap_ready_count + 2'd1);
    end
end
...
assign Block_Mat_exit22_pro_U0_ap_continue = 1'b1;

assign Block_Mat_exit22_pro_U0_ap_start = ((ap_sync_reg_Block_Mat_exit22_pro_U0_ap_ready ^ 1'b1) & ap_start);

assign Block_Mat_exit22_pro_U0_start_full_n = (start_for_Return_Plate_U0_full_n & start_for_Resize_U0_full_n & start_for_Add_Rectangle_U0_full_n);
...
assign Loop_BRAM_LOOP_proc1_U0_ap_continue = ap_sync_done;

assign Loop_BRAM_LOOP_proc1_U0_ap_start = start_for_Loop_BRAM_LOOP_proc1_U0_empty_n;

assign Loop_BRAM_LOOP_proc1_U0_start_full_n = 1'b1;

assign Loop_BRAM_LOOP_proc1_U0_start_write = 1'b0;
...
assign ap_idle = (Return_Plate_U0_ap_idle & Resize_U0_ap_idle & Mat2AXIvideo_U0_ap_idle & Loop_BRAM_LOOP_proc1_U0_ap_idle & Duplicate_U0_ap_idle & CvtColor_U0_ap_idle & Block_Mat_exit22_pro_U0_ap_idle & Add_Rectangle_U0_ap_idle & AXIvideo2Mat_U0_ap_idle);
...
assign ap_sync_Block_Mat_exit22_pro_U0_ap_ready = (ap_sync_reg_Block_Mat_exit22_pro_U0_ap_ready | Block_Mat_exit22_pro_U0_ap_ready);

assign ap_sync_continue = ap_sync_done;

assign ap_sync_done = (Mat2AXIvideo_U0_ap_done & Loop_BRAM_LOOP_proc1_U0_ap_done);

assign ap_sync_ready = (ap_sync_Block_Mat_exit22_pro_U0_ap_ready & ap_sync_AXIvideo2Mat_U0_ap_ready);

assign buffer_V_Addr_A = Loop_BRAM_LOOP_proc1_U0_buffer_V_Addr_A;
...
assign buffer_V_Din_A = Loop_BRAM_LOOP_proc1_U0_buffer_V_Din_A;

assign buffer_V_Din_B = 32'd0;

assign buffer_V_EN_A = Loop_BRAM_LOOP_proc1_U0_buffer_V_EN_A;
...
assign buffer_V_WEN_A = Loop_BRAM_LOOP_proc1_U0_buffer_V_WEN_A;
...
assign start_for_Loop_BRAM_LOOP_proc1_U0_din = 1'b1;
