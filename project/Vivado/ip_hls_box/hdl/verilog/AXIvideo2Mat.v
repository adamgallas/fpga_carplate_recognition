...
reg   [7:0] tmp_reg_521;
reg   [7:0] tmp_1_reg_526;
reg   [7:0] tmp_2_reg_531;
reg    ap_block_state8;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001) & (icmp_ln73_fu_420_p2 == 1'd0))) begin
        tmp_1_reg_526 <= {{ap_phi_mux_p_Val2_s_phi_fu_340_p4[15:8]}};
        tmp_2_reg_531 <= {{ap_phi_mux_p_Val2_s_phi_fu_340_p4[23:16]}};
...
assign icmp_ln73_fu_420_p2 = ((t_V_8_reg_300 == cols_V_reg_474) ? 1'b1 : 1'b0);

assign img_cols_V_out_din = img_cols_V_dout;

assign img_data_stream_0_V_din = tmp_reg_521;

assign img_data_stream_1_V_din = tmp_1_reg_526;

assign img_data_stream_2_V_din = tmp_2_reg_531;

assign img_rows_V_out_din = img_rows_V_dout;

assign j_V_fu_425_p2 = (t_V_8_reg_300 + 32'd1);
