...
module ov_carplate_v_mix_0_0_MultiPixStream2AXIvi (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
ov_carplate_v_mix_0_0_MultiPixStream2AXbkb #(
    .DataWidth( 2 ),
    .AddressRange( 3 ),
    .AddressWidth( 2 ))
mapComp_0_U(
...
ov_carplate_v_mix_0_0_reg_unsigned_short_s grp_reg_unsigned_short_s_fu_212(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
ov_carplate_v_mix_0_0_reg_unsigned_short_s grp_reg_unsigned_short_s_fu_218(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
ov_carplate_v_mix_0_0_v_mix_mux_32_8_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 8 ),
    .din1_WIDTH( 8 ),
...
endmodule //ov_carplate_v_mix_0_0_MultiPixStream2AXIvi
