...
xv_boost_lib_path=D:/Program_Files/Xilinx/Vivado/2019.2/tps/boost_1_64_0
...
{
  file="xsim.ini"
  lib_map_path="D:/Program_Files/Xilinx/Vivado/2019.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ov_carplate.wdb xsim.dir)
