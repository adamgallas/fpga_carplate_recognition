...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("input_layer_TDATA", 16, hls_in, 0, "axis", "in_data", 1),
	Port_Property("input_layer_TVALID", 1, hls_in, 6, "axis", "in_vld", 1),
	Port_Property("input_layer_TREADY", 1, hls_out, 6, "axis", "in_acc", 1),
	Port_Property("input_layer_TKEEP", 2, hls_in, 1, "axis", "in_data", 1),
	Port_Property("input_layer_TSTRB", 2, hls_in, 2, "axis", "in_data", 1),
	Port_Property("input_layer_TUSER", 1, hls_in, 3, "axis", "in_data", 1),
	Port_Property("input_layer_TLAST", 1, hls_in, 4, "axis", "in_data", 1),
	Port_Property("input_layer_TID", 1, hls_in, 5, "axis", "in_data", 1),
	Port_Property("input_layer_TDEST", 1, hls_in, 6, "axis", "in_data", 1),
...
const char* HLS_Design_Meta::dut_name = "Lenet_HLS";
