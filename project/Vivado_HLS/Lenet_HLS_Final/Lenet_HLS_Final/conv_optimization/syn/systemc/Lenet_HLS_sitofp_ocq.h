...
// ==============================================================
#ifndef __Lenet_HLS_sitofp_ocq__HH__
#define __Lenet_HLS_sitofp_ocq__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(Lenet_HLS_sitofp_ocq) {
    ...
    SC_CTOR(Lenet_HLS_sitofp_ocq):  ACMP_sitofp_U ("ACMP_sitofp_U") {
