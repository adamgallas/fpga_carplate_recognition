...
// ==============================================================
#ifndef __Lenet_HLS_fpext_3pcA__HH__
#define __Lenet_HLS_fpext_3pcA__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(Lenet_HLS_fpext_3pcA) {
    ...
    SC_CTOR(Lenet_HLS_fpext_3pcA):  ACMP_fpext_U ("ACMP_fpext_U") {
