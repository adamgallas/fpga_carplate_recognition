...
// ==============================================================
#ifndef __Lenet_HLS_mul_mulcud__HH__
#define __Lenet_HLS_mul_mulcud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Lenet_HLS_mul_mulcud) {
    ...
    SC_CTOR(Lenet_HLS_mul_mulcud):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
