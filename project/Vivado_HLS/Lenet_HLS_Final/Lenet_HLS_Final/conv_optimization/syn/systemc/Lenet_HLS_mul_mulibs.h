...
// ==============================================================
#ifndef __Lenet_HLS_mul_mulibs__HH__
#define __Lenet_HLS_mul_mulibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Lenet_HLS_mul_mulibs) {
    ...
    SC_CTOR(Lenet_HLS_mul_mulibs):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
