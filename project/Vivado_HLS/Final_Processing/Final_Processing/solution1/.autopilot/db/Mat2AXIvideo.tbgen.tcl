...
set portList { 
	...
	{ video_dst_TDATA sc_out sc_lv 32 signal 3 } 
	{ video_dst_TVALID sc_out sc_logic 1 outvld 9 } 
	{ video_dst_TREADY sc_in sc_logic 1 outacc 9 } 
	{ video_dst_TKEEP sc_out sc_lv 4 signal 4 } 
	{ video_dst_TSTRB sc_out sc_lv 4 signal 5 } 
	{ video_dst_TUSER sc_out sc_lv 1 signal 6 } 
	{ video_dst_TLAST sc_out sc_lv 1 signal 7 } 
	{ video_dst_TID sc_out sc_lv 1 signal 8 } 
	{ video_dst_TDEST sc_out sc_lv 1 signal 9 } 
}
set NewPortList {[ 
