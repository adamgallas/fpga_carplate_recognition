...
set ID 96
set hasByteEnable 0
set MemName Resize_opr_linearkbM
...
set ID 97
set hasByteEnable 0
set MemName Resize_opr_linearlbW
set CoreName ap_simcore_mem
set PortList { 1 0 }
set DataWd 8
set AddrRange 1281
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_src_rows_V_read { I 11 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_dst_rows_V_read { I 11 vector } } \
} "
}
