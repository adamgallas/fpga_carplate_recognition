...
// ==============================================================
#ifndef __top_sdiv_44ns_28smb6__HH__
#define __top_sdiv_44ns_28smb6__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_sdiv_44ns_28smb6) {
    ...
    SC_CTOR(top_sdiv_44ns_28smb6):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
