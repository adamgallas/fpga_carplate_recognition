...
AXIvideo2Mat::AXIvideo2Mat(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sc_trace(mVcdFile, t_V_12_reg_300, "t_V_12_reg_300");
    ...
    sc_trace(mVcdFile, tmp_31_reg_526, "tmp_31_reg_526");
    sc_trace(mVcdFile, tmp_32_reg_531, "tmp_32_reg_531");
...
void AXIvideo2Mat::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp1_stage0.read()) && 
         ...
         esl_seteq<1,1,1>(icmp_ln73_fu_420_p2.read(), ap_const_lv1_0) && 
         esl_seteq<1,1,1>(ap_block_pp1_stage0_11001.read(), ap_const_boolean_0))) {
        t_V_12_reg_300 = j_V_fu_425_p2.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read()) && 
                esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln71_fu_409_p2.read()))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp1_stage0.read()) && esl_seteq<1,1,1>(icmp_ln73_fu_420_p2.read(), ap_const_lv1_0) && esl_seteq<1,1,1>(ap_block_pp1_stage0_11001.read(), ap_const_boolean_0))) {
        tmp_31_reg_526 = ap_phi_mux_p_Val2_s_phi_fu_340_p4.read().range(15, 8);
        tmp_32_reg_531 = ap_phi_mux_p_Val2_s_phi_fu_340_p4.read().range(23, 16);
...
void AXIvideo2Mat::thread_icmp_ln73_fu_420_p2() {
    icmp_ln73_fu_420_p2 = (!t_V_12_reg_300.read().is_01() || !cols_V_reg_474.read().is_01())? sc_lv<1>(): sc_lv<1>(t_V_12_reg_300.read() == cols_V_reg_474.read());
}
...
void AXIvideo2Mat::thread_img_data_stream_1_V_din() {
    img_data_stream_1_V_din = tmp_31_reg_526.read();
}
...
void AXIvideo2Mat::thread_img_data_stream_2_V_din() {
    img_data_stream_2_V_din = tmp_32_reg_531.read();
}
...
void AXIvideo2Mat::thread_j_V_fu_425_p2() {
    j_V_fu_425_p2 = (!t_V_12_reg_300.read().is_01() || !ap_const_lv32_1.is_01())? sc_lv<32>(): (sc_biguint<32>(t_V_12_reg_300.read()) + sc_biguint<32>(ap_const_lv32_1));
}
