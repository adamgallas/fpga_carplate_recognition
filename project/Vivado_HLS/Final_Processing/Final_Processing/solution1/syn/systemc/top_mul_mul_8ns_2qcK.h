...
// ==============================================================
#ifndef __top_mul_mul_8ns_2qcK__HH__
#define __top_mul_mul_8ns_2qcK__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_mul_mul_8ns_2qcK) {
    ...
    SC_CTOR(top_mul_mul_8ns_2qcK):  ACMP_smul_us_U ("ACMP_smul_us_U") {
