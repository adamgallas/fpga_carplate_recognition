...
// ==============================================================
#ifndef __top_mul_mul_20ns_cud__HH__
#define __top_mul_mul_20ns_cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_mul_mul_20ns_cud) {
    ...
    SC_CTOR(top_mul_mul_20ns_cud):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
