...
void Mat2AXIvideo::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
        ...
        t_V_4_reg_190 = j_V_fu_224_p2.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
                esl_seteq<1,1,1>(regslice_both_AXI_video_strm_V_data_V_U_apdone_blk.read(), ap_const_logic_0) && 
                esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln125_fu_206_p2.read()))) {
...
void Mat2AXIvideo::thread_axi_last_V_fu_230_p2() {
    axi_last_V_fu_230_p2 = (!t_V_4_reg_190.read().is_01() || !ap_const_lv11_4FF.is_01())? sc_lv<1>(): sc_lv<1>(t_V_4_reg_190.read() == ap_const_lv11_4FF);
}
...
void Mat2AXIvideo::thread_icmp_ln126_fu_218_p2() {
    icmp_ln126_fu_218_p2 = (!t_V_4_reg_190.read().is_01() || !ap_const_lv11_500.is_01())? sc_lv<1>(): sc_lv<1>(t_V_4_reg_190.read() == ap_const_lv11_500);
}
...
void Mat2AXIvideo::thread_j_V_fu_224_p2() {
    j_V_fu_224_p2 = (!t_V_4_reg_190.read().is_01() || !ap_const_lv11_1.is_01())? sc_lv<11>(): (sc_biguint<11>(t_V_4_reg_190.read()) + sc_biguint<11>(ap_const_lv11_1));
}
