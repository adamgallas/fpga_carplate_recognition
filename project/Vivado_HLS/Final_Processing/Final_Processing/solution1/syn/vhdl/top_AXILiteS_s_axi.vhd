...
architecture behave of top_AXILiteS_s_axi is
    ...
    signal int_xleft_s         : UNSIGNED(31 downto 0) := (others => '0');
    signal int_xright_s        : UNSIGNED(31 downto 0) := (others => '0');
    signal int_ytop_s          : UNSIGNED(31 downto 0) := (others => '0');
    signal int_ydown_s         : UNSIGNED(31 downto 0) := (others => '0');
            ...
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_XLEFT_S_DATA_0 =>
                        rdata_data <= RESIZE(int_xleft_s(31 downto 0), 32);
                    when ADDR_XRIGHT_S_DATA_0 =>
                        rdata_data <= RESIZE(int_xright_s(31 downto 0), 32);
                    when ADDR_YTOP_S_DATA_0 =>
                        rdata_data <= RESIZE(int_ytop_s(31 downto 0), 32);
                    when ADDR_YDOWN_S_DATA_0 =>
                        rdata_data <= RESIZE(int_ydown_s(31 downto 0), 32);
                    when others =>
                        rdata_data <= (others => '0');
                    end case;
                end if;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_XLEFT_S_DATA_0) then
                    int_xleft_s(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_xleft_s(31 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_XRIGHT_S_DATA_0) then
                    int_xright_s(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_xright_s(31 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_YTOP_S_DATA_0) then
                    int_ytop_s(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_ytop_s(31 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_YDOWN_S_DATA_0) then
                    int_ydown_s(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_ydown_s(31 downto 0));
                end if;
            end if;
        end if;
    end process;
