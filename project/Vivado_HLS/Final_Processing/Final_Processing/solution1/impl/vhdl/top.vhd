...
architecture behav of top is 
    ...
    "top,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=11.100000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=9.645000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=26,HLS_SYN_DSP=34,HLS_SYN_FF=27281,HLS_SYN_LUT=34290,HLS_VERSION=2019_2}";
