...
architecture behav of Resize204 is 
    ...
    signal sext_ln2454_fu_180_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal sext_ln2454_reg_190 : STD_LOGIC_VECTOR (10 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal sext_ln2454_1_fu_185_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal sext_ln2454_1_reg_195 : STD_LOGIC_VECTOR (11 downto 0);
    signal p_src_rows_V_read_reg_200 : STD_LOGIC_VECTOR (10 downto 0);
    signal p_src_cols_V_read_reg_205 : STD_LOGIC_VECTOR (11 downto 0);
    signal grp_Resize_opr_linear_fu_166_ap_start : STD_LOGIC;
    signal grp_Resize_opr_linear_fu_166_ap_done : STD_LOGIC;
    signal grp_Resize_opr_linear_fu_166_ap_idle : STD_LOGIC;
    signal grp_Resize_opr_linear_fu_166_ap_ready : STD_LOGIC;
    signal grp_Resize_opr_linear_fu_166_p_src_data_stream_V_read : STD_LOGIC;
    signal grp_Resize_opr_linear_fu_166_p_dst_data_stream_V_din : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_Resize_opr_linear_fu_166_p_dst_data_stream_V_write : STD_LOGIC;
    signal grp_Resize_opr_linear_fu_166_ap_start_reg : STD_LOGIC := '0';
    signal ap_block_state1_ignore_call16 : BOOLEAN;
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal sext_ln2454_fu_180_p0 : STD_LOGIC_VECTOR (8 downto 0);
    signal sext_ln2454_1_fu_185_p0 : STD_LOGIC_VECTOR (9 downto 0);
...
begin
    grp_Resize_opr_linear_fu_166 : component Resize_opr_linear
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => grp_Resize_opr_linear_fu_166_ap_start,
        ap_done => grp_Resize_opr_linear_fu_166_ap_done,
        ap_idle => grp_Resize_opr_linear_fu_166_ap_idle,
        ap_ready => grp_Resize_opr_linear_fu_166_ap_ready,
        p_src_rows_V_read => p_src_rows_V_read_reg_200,
        p_src_cols_V_read => p_src_cols_V_read_reg_205,
        p_src_data_stream_V_dout => p_src_data_stream_V_dout,
        p_src_data_stream_V_empty_n => p_src_data_stream_V_empty_n,
        p_src_data_stream_V_read => grp_Resize_opr_linear_fu_166_p_src_data_stream_V_read,
        p_dst_rows_V_read => sext_ln2454_reg_190,
        p_dst_cols_V_read => sext_ln2454_1_reg_195,
        p_dst_data_stream_V_din => grp_Resize_opr_linear_fu_166_p_dst_data_stream_V_din,
        p_dst_data_stream_V_full_n => p_dst_data_stream_V_full_n,
        p_dst_data_stream_V_write => grp_Resize_opr_linear_fu_166_p_dst_data_stream_V_write);
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state2) and (grp_Resize_opr_linear_fu_166_ap_done = ap_const_logic_1))) then 
    ...
    grp_Resize_opr_linear_fu_166_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                grp_Resize_opr_linear_fu_166_ap_start_reg <= ap_const_logic_0;
            else
                if ((not(((real_start = ap_const_logic_0) or (p_dst_cols_V_out_full_n = ap_const_logic_0) or (p_dst_rows_V_out_full_n = ap_const_logic_0) or (p_dst_cols_V_empty_n = ap_const_logic_0) or (p_dst_rows_V_empty_n = ap_const_logic_0) or (p_src_cols_V_empty_n = ap_const_logic_0) or (p_src_rows_V_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                    grp_Resize_opr_linear_fu_166_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_Resize_opr_linear_fu_166_ap_ready = ap_const_logic_1)) then 
                    grp_Resize_opr_linear_fu_166_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((real_start = ap_const_logic_0) or (p_dst_cols_V_out_full_n = ap_const_logic_0) or (p_dst_rows_V_out_full_n = ap_const_logic_0) or (p_dst_cols_V_empty_n = ap_const_logic_0) or (p_dst_rows_V_empty_n = ap_const_logic_0) or (p_src_cols_V_empty_n = ap_const_logic_0) or (p_src_rows_V_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                p_src_cols_V_read_reg_205 <= p_src_cols_V_dout;
                p_src_rows_V_read_reg_200 <= p_src_rows_V_dout;
                sext_ln2454_1_reg_195 <= sext_ln2454_1_fu_185_p1;
                sext_ln2454_reg_190 <= sext_ln2454_fu_180_p1;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (real_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, p_src_rows_V_empty_n, p_src_cols_V_empty_n, p_dst_rows_V_empty_n, p_dst_cols_V_empty_n, p_dst_rows_V_out_full_n, p_dst_cols_V_out_full_n, grp_Resize_opr_linear_fu_166_ap_done, ap_CS_fsm_state2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state2) and (grp_Resize_opr_linear_fu_166_ap_done = ap_const_logic_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state2;
                end if;
    ...
    begin
                ap_block_state1 <= ((real_start = ap_const_logic_0) or (p_dst_cols_V_out_full_n = ap_const_logic_0) or (p_dst_rows_V_out_full_n = ap_const_logic_0) or (p_dst_cols_V_empty_n = ap_const_logic_0) or (p_dst_rows_V_empty_n = ap_const_logic_0) or (p_src_cols_V_empty_n = ap_const_logic_0) or (p_src_rows_V_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1));
    end process;


    ap_block_state1_ignore_call16_assign_proc : process(real_start, ap_done_reg, p_src_rows_V_empty_n, p_src_cols_V_empty_n, p_dst_rows_V_empty_n, p_dst_cols_V_empty_n, p_dst_rows_V_out_full_n, p_dst_cols_V_out_full_n)
    begin
                ap_block_state1_ignore_call16 <= ((real_start = ap_const_logic_0) or (p_dst_cols_V_out_full_n = ap_const_logic_0) or (p_dst_rows_V_out_full_n = ap_const_logic_0) or (p_dst_cols_V_empty_n = ap_const_logic_0) or (p_dst_rows_V_empty_n = ap_const_logic_0) or (p_src_cols_V_empty_n = ap_const_logic_0) or (p_src_rows_V_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1));
    end process;


    ap_done_assign_proc : process(ap_done_reg, grp_Resize_opr_linear_fu_166_ap_done, ap_CS_fsm_state2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (grp_Resize_opr_linear_fu_166_ap_done = ap_const_logic_1))) then 
    ...
    grp_Resize_opr_linear_fu_166_ap_start <= grp_Resize_opr_linear_fu_166_ap_start_reg;

    internal_ap_ready_assign_proc : process(grp_Resize_opr_linear_fu_166_ap_done, ap_CS_fsm_state2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (grp_Resize_opr_linear_fu_166_ap_done = ap_const_logic_1))) then 
    ...
    p_dst_data_stream_V_write_assign_proc : process(grp_Resize_opr_linear_fu_166_p_dst_data_stream_V_write, ap_CS_fsm_state2)
    begin
    ...
    p_src_data_stream_V_read_assign_proc : process(grp_Resize_opr_linear_fu_166_p_src_data_stream_V_read, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            p_src_data_stream_V_read <= grp_Resize_opr_linear_fu_166_p_src_data_stream_V_read;
        else 
    ...
    sext_ln2454_1_fu_185_p0 <= p_dst_cols_V_dout;
        sext_ln2454_1_fu_185_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(sext_ln2454_1_fu_185_p0),12));

    sext_ln2454_fu_180_p0 <= p_dst_rows_V_dout;
        sext_ln2454_fu_180_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(sext_ln2454_fu_180_p0),11));
