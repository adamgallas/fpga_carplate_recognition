...
set ID 75
set hasByteEnable 0
set MemName Resize_opr_linearbkb
...
set ID 76
set hasByteEnable 0
set MemName Resize_opr_lineareOg
set CoreName ap_simcore_mem
set PortList { 1 0 }
set DataWd 8
set AddrRange 1281
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_dst_rows_V_read { I 7 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_dst_cols_V_read { I 9 vector } } \
} "
}
