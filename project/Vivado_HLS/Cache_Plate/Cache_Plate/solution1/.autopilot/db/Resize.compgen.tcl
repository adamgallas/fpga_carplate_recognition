...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_dst_rows_V_dout { I 7 vector } p_dst_rows_V_empty_n { I 1 bit } p_dst_rows_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_dst_cols_V_dout { I 9 vector } p_dst_cols_V_empty_n { I 1 bit } p_dst_cols_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_dst_rows_V_out_din { O 7 vector } p_dst_rows_V_out_full_n { I 1 bit } p_dst_rows_V_out_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_dst_cols_V_out_din { O 9 vector } p_dst_cols_V_out_full_n { I 1 bit } p_dst_cols_V_out_write { O 1 bit } } \
} "
}
