...
// ==============================================================
#ifndef __box_sdiv_48ns_25sibs__HH__
#define __box_sdiv_48ns_25sibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(box_sdiv_48ns_25sibs) {
    ...
    SC_CTOR(box_sdiv_48ns_25sibs):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
