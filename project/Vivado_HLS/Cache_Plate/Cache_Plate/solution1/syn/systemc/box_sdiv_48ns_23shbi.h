...
// ==============================================================
#ifndef __box_sdiv_48ns_23shbi__HH__
#define __box_sdiv_48ns_23shbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(box_sdiv_48ns_23shbi) {
    ...
    SC_CTOR(box_sdiv_48ns_23shbi):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
