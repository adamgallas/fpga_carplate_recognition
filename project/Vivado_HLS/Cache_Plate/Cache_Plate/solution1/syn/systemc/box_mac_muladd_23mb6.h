...
// ==============================================================
#ifndef __box_mac_muladd_23mb6__HH__
#define __box_mac_muladd_23mb6__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(box_mac_muladd_23mb6) {
    ...
    SC_CTOR(box_mac_muladd_23mb6):  simcore_mac_0_U ("simcore_mac_0_U") {
