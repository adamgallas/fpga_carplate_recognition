...
// ==============================================================
#ifndef __box_mac_muladd_20ncg__HH__
#define __box_mac_muladd_20ncg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(box_mac_muladd_20ncg) {
    ...
    SC_CTOR(box_mac_muladd_20ncg):  simcore_mac_1_U ("simcore_mac_1_U") {
