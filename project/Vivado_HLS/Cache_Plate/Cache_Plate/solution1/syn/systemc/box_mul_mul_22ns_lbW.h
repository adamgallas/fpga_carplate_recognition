...
// ==============================================================
#ifndef __box_mul_mul_22ns_lbW__HH__
#define __box_mul_mul_22ns_lbW__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(box_mul_mul_22ns_lbW) {
    ...
    SC_CTOR(box_mul_mul_22ns_lbW):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
