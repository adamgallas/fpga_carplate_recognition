...
wire   [0:0] icmp_ln64_fu_307_p2;
wire    ap_block_state2_pp0_stage0_iter0;
reg    ap_block_state3_pp0_stage0_iter1;
reg    ap_block_pp0_stage0_11001;
wire   [19:0] add_ln64_fu_313_p2;
reg    ap_enable_reg_pp0_iter0;
wire   [9:0] select_ln64_2_fu_367_p3;
wire   [0:0] or_ln68_2_fu_395_p2;
wire   [10:0] j_fu_401_p2;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state2;
reg    ap_block_pp0_stage0_01001;
wire   [31:0] zext_ln64_fu_287_p1;
wire   [0:0] icmp_ln68_fu_291_p2;
wire   [0:0] icmp_ln68_1_fu_296_p2;
wire   [0:0] icmp_ln65_fu_319_p2;
wire   [9:0] add_ln64_1_fu_333_p2;
wire   [31:0] zext_ln64_1_fu_339_p1;
wire   [0:0] icmp_ln68_4_fu_343_p2;
wire   [0:0] icmp_ln68_5_fu_348_p2;
wire   [0:0] or_ln68_3_fu_353_p2;
wire   [0:0] or_ln68_1_fu_301_p2;
wire   [10:0] select_ln64_fu_325_p3;
wire   [31:0] zext_ln65_fu_375_p1;
wire   [0:0] icmp_ln68_2_fu_379_p2;
wire   [0:0] icmp_ln68_3_fu_384_p2;
wire   [0:0] select_ln64_1_fu_359_p3;
wire   [0:0] or_ln68_fu_389_p2;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln64_fu_307_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln64_fu_307_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if ((icmp_ln64_fu_307_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((icmp_ln64_reg_429 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln64_reg_429 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if (((or_ln68_2_reg_443 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((or_ln68_2_reg_443 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if (~((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln64_fu_307_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln64_fu_307_p2 == 1'd1))) begin
...
assign add_ln64_1_fu_333_p2 = (i_0_i_reg_265 + 10'd1);

assign add_ln64_fu_313_p2 = (indvar_flatten_reg_254 + 20'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((or_ln68_2_reg_443 == 1'd0) & (output_plate_data_stream_2_V_full_n == 1'b0)) | ((or_ln68_2_reg_443 == 1'd0) & (output_plate_data_stream_1_V_full_n == 1'b0)) | ((or_ln68_2_reg_443 == 1'd0) & (output_plate_data_stream_0_V_full_n == 1'b0)) | ((icmp_ln64_reg_429 == 1'd0) & (input_img_data_stream_2_V_empty_n == 1'b0)) | ((icmp_ln64_reg_429 == 1'd0) & (input_img_data_stream_1_V_empty_n == 1'b0)) | ((icmp_ln64_reg_429 == 1'd0) & (input_img_data_stream_0_V_empty_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((or_ln68_2_reg_443 == 1'd0) & (output_plate_data_stream_2_V_full_n == 1'b0)) | ((or_ln68_2_reg_443 == 1'd0) & (output_plate_data_stream_1_V_full_n == 1'b0)) | ((or_ln68_2_reg_443 == 1'd0) & (output_plate_data_stream_0_V_full_n == 1'b0)) | ((icmp_ln64_reg_429 == 1'd0) & (input_img_data_stream_2_V_empty_n == 1'b0)) | ((icmp_ln64_reg_429 == 1'd0) & (input_img_data_stream_1_V_empty_n == 1'b0)) | ((icmp_ln64_reg_429 == 1'd0) & (input_img_data_stream_0_V_empty_n == 1'b0))));
end
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter1 = (((or_ln68_2_reg_443 == 1'd0) & (output_plate_data_stream_2_V_full_n == 1'b0)) | ((or_ln68_2_reg_443 == 1'd0) & (output_plate_data_stream_1_V_full_n == 1'b0)) | ((or_ln68_2_reg_443 == 1'd0) & (output_plate_data_stream_0_V_full_n == 1'b0)) | ((icmp_ln64_reg_429 == 1'd0) & (input_img_data_stream_2_V_empty_n == 1'b0)) | ((icmp_ln64_reg_429 == 1'd0) & (input_img_data_stream_1_V_empty_n == 1'b0)) | ((icmp_ln64_reg_429 == 1'd0) & (input_img_data_stream_0_V_empty_n == 1'b0)));
end

assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);

assign icmp_ln64_fu_307_p2 = ((indvar_flatten_reg_254 == 20'd921600) ? 1'b1 : 1'b0);

assign icmp_ln65_fu_319_p2 = ((j_0_i_reg_276 == 11'd1280) ? 1'b1 : 1'b0);

assign icmp_ln68_1_fu_296_p2 = (($signed(zext_ln64_fu_287_p1) > $signed(ydown_read_reg_423)) ? 1'b1 : 1'b0);

assign icmp_ln68_2_fu_379_p2 = (($signed(zext_ln65_fu_375_p1) < $signed(xleft_read_reg_407)) ? 1'b1 : 1'b0);

assign icmp_ln68_3_fu_384_p2 = (($signed(zext_ln65_fu_375_p1) > $signed(xright_read_reg_412)) ? 1'b1 : 1'b0);

assign icmp_ln68_4_fu_343_p2 = (($signed(zext_ln64_1_fu_339_p1) < $signed(ytop_read_reg_417)) ? 1'b1 : 1'b0);

assign icmp_ln68_5_fu_348_p2 = (($signed(zext_ln64_1_fu_339_p1) > $signed(ydown_read_reg_423)) ? 1'b1 : 1'b0);

assign icmp_ln68_fu_291_p2 = (($signed(zext_ln64_fu_287_p1) < $signed(ytop_read_reg_417)) ? 1'b1 : 1'b0);

assign j_fu_401_p2 = (select_ln64_fu_325_p3 + 11'd1);

assign or_ln68_1_fu_301_p2 = (icmp_ln68_fu_291_p2 | icmp_ln68_1_fu_296_p2);

assign or_ln68_2_fu_395_p2 = (select_ln64_1_fu_359_p3 | or_ln68_fu_389_p2);

assign or_ln68_3_fu_353_p2 = (icmp_ln68_5_fu_348_p2 | icmp_ln68_4_fu_343_p2);

assign or_ln68_fu_389_p2 = (icmp_ln68_3_fu_384_p2 | icmp_ln68_2_fu_379_p2);
...
assign select_ln64_1_fu_359_p3 = ((icmp_ln65_fu_319_p2[0:0] === 1'b1) ? or_ln68_3_fu_353_p2 : or_ln68_1_fu_301_p2);

assign select_ln64_2_fu_367_p3 = ((icmp_ln65_fu_319_p2[0:0] === 1'b1) ? add_ln64_1_fu_333_p2 : i_0_i_reg_265);

assign select_ln64_fu_325_p3 = ((icmp_ln65_fu_319_p2[0:0] === 1'b1) ? 11'd0 : j_0_i_reg_276);

assign zext_ln64_1_fu_339_p1 = add_ln64_1_fu_333_p2;

assign zext_ln64_fu_287_p1 = i_0_i_reg_265;

assign zext_ln65_fu_375_p1 = select_ln64_fu_325_p3;
