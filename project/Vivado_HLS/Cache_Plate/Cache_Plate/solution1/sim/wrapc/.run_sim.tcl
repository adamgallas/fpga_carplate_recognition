...
# ==============================================================
set ::env(PATH) "$::env(PATH);D:/Program_Files/Xilinx/Vivado/2019.2/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);D:/Program_Files/Xilinx/Vivado/2019.2/win64/tools/opencv"
set ::env(PATH) "$::env(PATH);D:/Program_Files/Xilinx/Vivado/2019.2/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);D:/Program_Files/Xilinx/Vivado/2019.2/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);D:/Program_Files/Xilinx/Vivado/2019.2/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "box.autotvin.dat"
	set constFileTvOut       "box.autotvout.dat"
	set constFileHdlTvIn     "box.autohdltvin.dat"
	set constFileHdlTvOut    "box.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
