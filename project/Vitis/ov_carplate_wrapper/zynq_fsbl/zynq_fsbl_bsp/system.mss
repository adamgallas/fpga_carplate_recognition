...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = Lenet_HLS
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = Lenet_HLS_0
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = box
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = box_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = oled_driver
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = oled_driver_0
END
